...
class Rajaongkir extends CI_Controller
{
    ...
    private $api_key = '5174af2473981821cef79e6dfca8bd4b';
    ...
    public function paket()
    {
        ...
        curl_setopt_array($curl, array(
            ...
            CURLOPT_HTTPHEADER => array(
                ...
                "key: " . $this->api_key // Pastikan API key benar
            ),
        ));
        ...
        if ($err) {
            ...
            foreach ($data_paket as $key => $value) {
                ...
                echo $value['service'] . " | IDR." . $value['cost'][0]['value'] . " | " . $value['cost'][0]['etd'] . " Hari";
                echo "</option>";
            }
        }
    }

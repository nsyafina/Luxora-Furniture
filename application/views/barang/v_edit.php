<div class="col-md-12 mt-3">
    ...
    <div class="card" style="border-top: 4px solid #0b544b; border-bottom: 4px solid #0b544b; border-radius: 10px;">
        <div class="card-header">
            <h3 class="card-title" style="color: #0b544b;">Form Edit Barang</h3>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
            <?php
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <input style="border: 2px solid #0b544b;" name="harga" class="form-control" placeholder="Harga Barang ..." value="<?= $barang->harga ?>">
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="form-group">
                        <label style="color: #0b544b;">Berat (Kg)</label>
                        <input style="border: 2px solid #0b544b;" type="number" name="berat" min="0" class="form-control" placeholder="Berat Dalam Satuan Kilogram ..." value="<?= $barang->berat ?>">
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <input style="border: 2px solid #0b544b;" name="material" class="form-control" placeholder="Material Barang ..." value="<?= $barang->material ?>">
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="form-group">
                        <label style="color: #0b544b;">Warna</label>
                        <input style="border: 2px solid #0b544b;" name="warna" class="form-control" placeholder="Warna Barang ..." value="<?= $barang->warna ?>">
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="form-group">
                        <label style="color: #0b544b;">Kapasitas</label>
                        <input style="border: 2px solid #0b544b;" name="kapasitas" class="form-control" placeholder="Kapasitas Barang ..." value="<?= $barang->kapasitas ?>">
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input style="border: 2px solid #0b544b; height: 45px;" type="file" name="gambar" class="form-control" id="preview_gambar">
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">

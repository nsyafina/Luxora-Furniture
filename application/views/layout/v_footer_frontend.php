<footer class="bg-footer lg:grid lg:grid-cols-5">
    <div class="relative block h-32 lg:col-span-2 lg:h-full">
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3966.3006207173453!2d106.83809178885498!3d-6.224035300000002!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69f38d200f03e5%3A0xaf54cb631563acce!2sMall%20Kota%20Kasablanka!5e0!3m2!1sid!2sid!4v1728299329211!5m2!1sid!2sid"
            allowfullscreen=""
            loading="lazy"
        ...
        <div class="mt-12 border-t border-gray-100 pt-12">
            <div class="sm:flex sm:items-center sm:justify-between">
                <ul class="flex flex-wrap gap-4 text-md">
                    ...
                    <li>
                        <a href="#" class="text-gray-700 transition hover:opacity-75"> Cookies </a>
                    </li>
                </ul>

                <p class=" text-md text-gray-300 sm:mt-0">
                    &copy; 2024. Luxora Interiors. All rights reserved.
                </p>
            </div>
        </div>
    </div>

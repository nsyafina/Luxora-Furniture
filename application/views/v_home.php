<!------------ BANNER ------------>
<section class="banner overflow-hidden sm:grid sm:grid-cols-2 sm:items-center">
  <div class="p-8 md:p-12 lg:px-16 lg:py-24">
    <div class="mx-auto max-w-xl text-center ltr:sm:text-left rtl:sm:text-right">
      ...
      <p class="hidden text-gray-300 md:mt-4 md:block">
        Temukan keanggunan baru untuk hunian Anda bersama Luxora Interiors.
        Kami menghadirkan koleksi furniture premium yang memadukan desain klasik dan
        sentuhan modern untuk menciptakan ruangan yang indah dan nyaman.
      </p>

      <div class="mt-4 md:mt-8">
        <a href="#" class="btn-banner">Find Your Comfort!</a>
      </div>
    </div>
  </div>

  <div class="banner-img h-full w-full object-cover sm:h-[calc(100%_-_2rem)] sm:self-end sm:rounded-ss-[30px] md:h-[calc(100%_-_1rem)] md:rounded-ss-[60px]"></div>
</section>
<!------------ BANNER ------------>
        ...
        <div class="mt-32 sm:mt-48 lg:mt-64">
          <div
            ...
            <p class="text-sm text-white">
              Ciptakan suasana istirahat yang tenang dan mewah dengan koleksi furnitur kamar tidur kami.
              Nikmati kenyamanan dan desain elegan yang menjadikan tidur Anda lebih berkualitas.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="relative p-4 sm:p-6 lg:p-8">
        ...
        <div class="mt-32 sm:mt-48 lg:mt-64">
          <div
            class="translate-y-8 transform opacity-0 transition-all group-hover:translate-y-0 group-hover:opacity-100">
            <p class="text-sm text-white">
              Tingkatkan pengalaman bersantap Anda dengan furnitur ruang makan yang memadukan keindahan dan fungsi.
              Ciptakan momen berharga bersama keluarga di ruang makan yang penuh gaya.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="relative p-4 sm:p-6 lg:p-8">
        ...
        <div class="mt-32 sm:mt-48 lg:mt-64">
          <div
            class="translate-y-8 transform opacity-0 transition-all group-hover:translate-y-0 group-hover:opacity-100">
            <p class="text-sm text-white">
              Ubah ruang tamu Anda menjadi pusat kenyamanan dan estetika. Pilih dari berbagai sofa, meja,
              dan aksesoris untuk menciptakan ruang yang hangat dan mengundang. Ciptakan momen berharga bersama keluarga.
            </p>
          </div>
        </div>
      </div>
...
<section data-aos="fade-up" data-aos-duration="1000" class="container-about">
  <div class=" mx-auto max-w-screen-2xl px-4 py-10 sm:px-6 lg:px-8">
    <div class="grid grid-cols-1 lg:h-screen lg:grid-cols-2">
      ...
      <div class="relative flex items-center about">
        <span
          class="hidden lg:absolute lg:inset-y-0 lg:-start-16 lg:block lg:w-16 about                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  "></span>
        ...
        <div class="p-8 sm:p-16 lg:p-24">
          ...
          <p class="mt-4 des-about">
            Luxora Interiors adalah penyedia furniture premium yang mengutamakan gaya, kualitas, dan kenyamanan.
            Kami menghadirkan solusi interior elegan untuk menciptakan ruangan yang penuh keindahan dan fungsionalitas.
            Setiap produk dirancang dengan detail dan bahan berkualitas tinggi untuk memenuhi kebutuhan dan selera pelanggan kami.
            Dengan koleksi yang terinspirasi dari desain modern dan klasik,
            Luxora Interiors berkomitmen untuk membantu Anda mewujudkan rumah impian yang mewah dan nyaman.
          </p>
        </div>
      </div>
    </div>
...
<section data-aos="fade-up" data-aos-duration="1000" style="background: transparent;" class="container-team">
  <div class="mx-auto">
    <div class="grid grid-cols-1 gap-4 mt-1 xl:mt-1 md:grid-cols-2 xl:grid-cols-2">
      <div data-aos="fade-up" data-aos-duration="1000" style="background: linear-gradient(45deg, rgba(13, 106, 94, 1) 0%, rgba(67, 153, 142, 1) 47%, rgba(67, 153, 142, 1) 56%, rgba(11, 84, 75, 1) 100%);" class="px-12 py-8 transition-colors duration-300 transform border cursor-pointer rounded-xl hover:border-transparent group hover:bg-teal-800 dark:border-gray-700 dark:hover:border-transparent">
        <div class="flex flex-col sm:-mx-4 sm:flex-row">
          ...
          <div class="mt-4 sm:mx-4 sm:mt-0">
            ...
            <p class=" nim-team mt-2 capitalize ">15210232</p>
          </div>
        </div>
        ...
        <div class="flex mt-4 -mx-2">
          ...
          <a href="#" class="mx-2 icon-team " aria-label="Instagram">
            <svg class="w-6 h-6 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!--!Font Awesome Free 6.7.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
          ...
          <a href="#" class="mx-2 icon-team " aria-label="Github">
      ...
      <div data-aos="fade-up" data-aos-duration="1000" style="background: linear-gradient(45deg, rgba(13, 106, 94, 1) 0%, rgba(67, 153, 142, 1) 47%, rgba(67, 153, 142, 1) 56%, rgba(11, 84, 75, 1) 100%);" class="px-12 py-8 transition-colors duration-300 transform border cursor-pointer rounded-xl hover:border-transparent group hover:bg-teal-800 dark:border-gray-700 dark:hover:border-transparent">
        <div class="flex flex-col sm:-mx-4 sm:flex-row">
          ...
          <div class="mt-4 sm:mx-4 sm:mt-0">
            ...
            <p class=" nim-team mt-2 capitalize ">15220277</p>
          </div>
        </div>
        ...
        <div class="flex mt-4 -mx-2">
          ...
          <a href="#" class="mx-2 icon-team " aria-label="Facebook">
            <svg class="w-6 h-6 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!--!Font Awesome Free 6.7.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
              <path d="M224.1 141c-63.6 0-114.9 51.3-114.9 114.9s51.3 114.9 114.9 114.9S339 319.5 339 255.9 287.7 141 224.1 141zm0 189.6c-41.1 0-74.7-33.5-74.7-74.7s33.5-74.7 74.7-74.7 74.7 33.5 74.7 74.7-33.6 74.7-74.7 74.7zm146.4-194.3c0 14.9-12 26.8-26.8 26.8-14.9 0-26.8-12-26.8-26.8s12-26.8 26.8-26.8 26.8 12 26.8 26.8zm76.1 27.2c-1.7-35.9-9.9-67.7-36.2-93.9-26.2-26.2-58-34.4-93.9-36.2-37-2.1-147.9-2.1-184.9 0-35.8 1.7-67.6 9.9-93.9 36.1s-34.4 58-36.2 93.9c-2.1 37-2.1 147.9 0 184.9 1.7 35.9 9.9 67.7 36.2 93.9s58 34.4 93.9 36.2c37 2.1 147.9 2.1 184.9 0 35.9-1.7 67.7-9.9 93.9-36.2 26.2-26.2 34.4-58 36.2-93.9 2.1-37 2.1-147.8 0-184.8zM398.8 388c-7.8 19.6-22.9 34.7-42.6 42.6-29.5 11.7-99.5 9-132.1 9s-102.7 2.6-132.1-9c-19.6-7.8-34.7-22.9-42.6-42.6-11.7-29.5-9-99.5-9-132.1s-2.6-102.7 9-132.1c7.8-19.6 22.9-34.7 42.6-42.6 29.5-11.7 99.5-9 132.1-9s102.7-2.6 132.1 9c19.6 7.8 34.7 22.9 42.6 42.6 11.7 29.5 9 99.5 9 132.1s2.7 102.7-9 132.1z" />
            </svg>
          </a>
      ...
      <div data-aos="fade-up" data-aos-duration="1000" style="background: linear-gradient(45deg, rgba(13, 106, 94, 1) 0%, rgba(67, 153, 142, 1) 47%, rgba(67, 153, 142, 1) 56%, rgba(11, 84, 75, 1) 100%);" class="px-12 py-8 transition-colors duration-300 transform border cursor-pointer rounded-xl hover:border-transparent group hover:bg-teal-800 dark:border-gray-700 dark:hover:border-transparent">
        <div class="flex flex-col sm:-mx-4 sm:flex-row">
          <img class="flex-shrink-0 object-cover w-24 h-24 rounded-full sm:mx-4 ring-4 ring-gray-300" src="<?= base_url() ?>img/team/rahman2.jpg" alt="">

          <div class="mt-4 sm:mx-4 sm:mt-0">
            <h1 class=" nama-team text-xl font-semibold capitalize md:text-2xl">Rahman Nurhadi</h1>

            <p class=" nim-team mt-2 capitalize ">15220161</p>
          </div>
        </div>

        <p class=" des-team mt-4 capitalize">Pengembang web yang bersemangat dengan latar belakang kuat di bidang Ilmu Komputer. Senang mengeksplorasi teknologi baru dan mengatasi tantangan teknis.</p>
      ...
      <div data-aos="fade-up" data-aos-duration="1000" style="background: linear-gradient(45deg, rgba(13, 106, 94, 1) 0%, rgba(67, 153, 142, 1) 47%, rgba(67, 153, 142, 1) 56%, rgba(11, 84, 75, 1) 100%);" class="px-12 py-8 transition-colors duration-300 transform border cursor-pointer rounded-xl hover:border-transparent group hover:bg-teal-800 dark:border-gray-700 dark:hover:border-transparent">
        <div class="flex flex-col sm:-mx-4 sm:flex-row">
          <img class="flex-shrink-0 object-cover w-24 h-24 rounded-full sm:mx-4 ring-4 ring-gray-300" src="<?= base_url() ?>img/team/rangga2.jpg" alt="">

          <div class="mt-4 sm:mx-4 sm:mt-0">
            <h1 class=" nama-team text-xl font-semibold capitalize md:text-2xl">Rangga Ryantico</h1>

            <p class=" nim-team mt-2 capitalize ">15220089</p>
          </div>
        </div>
      ...
      <div data-aos="fade-up" data-aos-duration="1000" style="background: linear-gradient(45deg, rgba(13, 106, 94, 1) 0%, rgba(67, 153, 142, 1) 47%, rgba(67, 153, 142, 1) 56%, rgba(11, 84, 75, 1) 100%);" class="px-12 py-8 transition-colors duration-300 transform border cursor-pointer rounded-xl hover:border-transparent group hover:bg-teal-800 dark:border-gray-700 dark:hover:border-transparent">
        <div class="flex flex-col sm:-mx-4 sm:flex-row">
          <img class="flex-shrink-0 object-cover w-24 h-24 rounded-full sm:mx-4 ring-4 ring-gray-300" src="<?= base_url() ?>img/team/revan2.jpg" alt="">

          <div class="mt-4 sm:mx-4 sm:mt-0">
            <h1 class=" nama-team text-xl font-semibold capitalize md:text-2xl">Revanda Ghofar. P </h1>

            <p class=" nim-team mt-2 capitalize ">15220095</p>
          </div>
        </div>

        <p class=" des-team mt-4 capitalize">Seorang programmer yang berdedikasi dan memiliki keterampilan kuat dalam Ilmu Komputer, dengan minat mendalam pada pengembangan web.</p>
...
<div data-aos="fade-up" data-aos-duration="1000" class="space-y-4 container-faq mb-3">
  <details class="group rounded-lg p-6 [&_summary::-webkit-details-marker]:hidden" style="background-color: #F2EDDB; border-left: 4px solid #0b544b; border-right: 4px solid #0b544b;" open>
    ...
    <p class="mt-4 leading-relaxed text-black">
      Jika Anda menerima produk yang rusak atau cacat, segera hubungi kami dalam waktu 7 hari setelah pengiriman.
      Kirimkan foto produk yang rusak beserta nomor pesanan ke email kami di [luxorainteriorsofficial@gmail.com],
      dan tim layanan pelanggan kami akan memproses penggantian atau pengembalian dana sesuai dengan kebijakan toko kami.
    </p>
  </details>
  ...
  <details class="group rounded-lg p-6 [&_summary::-webkit-details-marker]:hidden" style="background-color: #F2EDDB; border-left: 4px solid #0b544b; border-right: 4px solid #0b544b;">
    ...
    <p class="mt-4 leading-relaxed text-black">
      Maaf, saat ini produk kami tidak dapat dikustomisasi.
    </p>
  </details>
  ...
  <details class="group rounded-lg p-6 [&_summary::-webkit-details-marker]:hidden" style="background-color: #F2EDDB; border-left: 4px solid #0b544b; border-right: 4px solid #0b544b;">
    ...
    <p class="mt-4 leading-relaxed text-black">
      Pengiriman biasanya memakan waktu 5-10 hari kerja, tergantung lokasi dan produk.
      Anda akan menerima nomor pelacakan setelah pengiriman.
    </p>
  </details>
</div>
<!------------ FAQs -------------->